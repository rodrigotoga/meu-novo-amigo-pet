    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_conta', models.CharField(choices=[('Individual', 'Individual'), ('ONG', 'ONG')], default='Individual', max_length=20, verbose_name='Tipo de conta')),
                ('verificado', models.BooleanField(default=False, help_text='Selo de confiança para ONGs/Protetores', verbose_name='Verificado')),
